...
- Deployed to a live URL you can share immediately
- A dashboard to manage, regenerate, or update your site

---

### The stack

Built with Next.js, Tailwind CSS, and Supabase. Sites are generated using Claude by Anthropic. Deployed via Vercel.
...
Made by [Ishaan Narang](https://github.com/Ishaannarang22).
